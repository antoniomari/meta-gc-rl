...
PARAM_GRID = {
    'env_name': ['pointmaze-medium-stitch-v0', 'pointmaze-medium-navigate-v0'],
    'agent.agent_name': ['gciql'],
    'finetune.actor_loss': ['awr'],
    'finetune.lr': [0, 3.e-4, 3.e-5],
    'finetune.num_steps': [0, 50, 100, 200],
    'finetune.filter_by_mc': [False],
    'finetune.filter_by_recursive_mdp': [False],
    'finetune.replan_horizon': [100, 200],
    # run tag for the group is: "pointmaze-additional"
    #'run_tags': ['pointmaze-additional'],
    'run_group': ['pointmaze-additional'],
}
